...
//-----------------------------------------------
/*
* This is a free function which accepts a vector and
* an integer value and then based on the integer value
* it either returns root1 or root2 for the vector.
*/
//-----------------------------------------------
void printEigenvalues(vector<double> numbers, int number){
	if(number > 2){
  ...
  if(numbers.size() == 1){
    ...
    if(number == 1){
        cout << "root 1: " << numbers[0] << " " << showpos << numbers[1] << noshowpos << "i" << endl;
    }
    else{
        cout << "root 2: " << numbers[0] << " " << showpos << numbers[1] << noshowpos << "i" << endl;
    }
  }
}
